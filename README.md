...
> **SSH clone error?** If install fails with `Permission denied (publickey)`, this is a [known Claude Code bug](https://github.com/anthropics/claude-code/issues/31930) — plugin cloning uses SSH instead of HTTPS. Fix it once with:
> ```bash
> git config --global url."https://github.com/".insteadOf "git@github.com:"
> ```
> Then retry the install. This affects all Claude Code plugins, not just this one.
